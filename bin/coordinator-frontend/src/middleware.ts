...
export function middleware(request: NextRequest) {
  ...
  const publicRoutes = ['/login', '/login/createNewAccount', '/login/loadExistingWallet', '/testing', '/testingWalletSign'];
...
export const config = {
  matcher: [
     ...
     * - testing (testing page - bypasses middleware)
     */
    '/((?!api|_next/static|_next/image|favicon.ico|public|testing|testingWalletSign).*)',
  ],
};
