              ...
              >
                <div className="w-full  flex flex-col items-center">
                  ...
                  <div className="font-dmmono font-[400] text-[#000000] opacity-[40%] lg:text-[14px] md:text-[13px] sm:text-[12px] text-[11px]">
                    Set up your wallet name and security settings
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-center gap-2 pt-4">
                    {formData.signerAddresses.map((_, i) => (
                      <button
                        ...
                        className={`w-5 h-5 lg:w-6 lg:h-6 md:w-5.5 md:h-5.5 sm:w-5 sm:h-5 flex items-center justify-center rounded-md border-2 transition-all duration-200 hover:scale-110 ${
                          i === activeSignerIndex
